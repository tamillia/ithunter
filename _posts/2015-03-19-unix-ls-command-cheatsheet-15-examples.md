...
`ls` &mdash; пользователи Unix и системные администраторы не могут жить без этой команды. Используете ли вы эту команду 10 или 100 раз в день, знание всей мощи команды `ls` позволит сделать процесс использования консоли приятнее.
