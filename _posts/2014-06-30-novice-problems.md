...
**Найти число пи до n-й цифры после запятой** - Введите число, и программа начнет генерировать число пи. Поставьте определенный предел, до которого программа должна дойти. Реализации: [Python №1](https://github.com/MrBlaise/learnpython/blob/master/Numbers/pi.py), [Python №2](https://github.com/whoshuu/Projects/blob/master/Numbers/pi.py), [Haskell](https://github.com/tel/Projects/blob/master/Numbers/Pi.hs), [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/pi.rb), [PHP](https://github.com/atomic22/problem_solving/blob/master/Pi_to_Nth.php), [JavaScript](https://github.com/quitrk/LearningJS/blob/master/Numbers/00.%20Find%20PI%20to%20the%20Nth%20Digit.js), [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/pi.go), [Python](https://github.com/pkoli/FirstProject/blob/master/pi.py)

**Последовательность Фибоначчи** - Введите число, и программа сгенерирует последовательность Фибоначчи до этого числа или до N-го числа. Реализации: [Python №1](https://github.com/MrBlaise/learnpython/blob/master/Numbers/fibonacci.py), [Python №2](https://github.com/timkaboya/cached_fibo/blob/master/cached_fibo.py), [Python №3](https://github.com/whoshuu/Projects/blob/master/Numbers/fibonacci.py), [Bash](https://github.com/mayankj08/Shell-Script-Collection/blob/master/calcualte_fibonacci_numbers.sh), [Haskell](https://github.com/tel/Projects/blob/master/Numbers/Fibonacci.hs), [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/fib.rb), [С](https://github.com/bolcselo/Projects/blob/master/Numbers/fibonacci.c), [PHP](https://github.com/atomic22/problem_solving/blob/master/fibseq.php), [JavaScript](https://github.com/quitrk/LearningJS/blob/master/Numbers/01.%20Fibonacci%20Sequence.js), [C# ](https://github.com/luisccastillo/Projects/blob/master/Numbers/fibonacci_sequence.cs), [Java](https://github.com/MikroMan/Contributions/blob/master/Fibonacci.java), [Python №4](https://github.com/coderickl4m4r/scribble/blob/master/Projects/fibonacci.py), [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/fibonacci.go), [Python №5](https://github.com/brotatotes/myStuff/blob/master/Fibonacci_Sequence.py), [C++](https://github.com/mandliya/practice/blob/master/fib.cpp), [Python №6](https://github.com/codefacekillah/Projects/blob/master/Numbers/fibonacci.py), [Python №7](https://github.com/Silverneo/pylearn/blob/master/Fibonacci.py)

**Разложение на произведение простых чисел** - Пользователь вводит число и находит программа раскладывает на произведение простых чисел с их степенями. Реализации: [Python №1](https://github.com/MrBlaise/learnpython/blob/master/Numbers/prime.py),  [Python №2](https://github.com/whoshuu/Projects/blob/master/Numbers/prime.py), [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/prime_factorization.rb),  [Haskell](https://github.com/aterkik/Projects/blob/master/Numbers/primeFactors.hs),  [С](https://github.com/bolcselo/Projects/blob/master/Numbers/prime.c), [JavaScript](https://github.com/quitrk/LearningJS/blob/master/Numbers/02.%20Prime%20Factorization.js), [Java](https://github.com/MikroMan/Contributions/blob/master/Factors.java), [C++](https://github.com/checkcheckzz/coding-problem/blob/master/problem/Primefactors.cpp), [Javascript](https://github.com/kdamball/Numbers/blob/master/primeFactors.js), [Python №3](https://github.com/Tartuffe1/Projects/blob/master/Numbers/prime_factorization.py)

**Следующее простое число** - Программа находит простые числа до тех пор, пока пользователь перестанет спрашивать. Реализации: [Python №1](https://github.com/MrBlaise/learnpython/blob/master/Numbers/next_prime.py), [Haskell](https://github.com/tel/Projects/blob/master/Numbers/NextPrime.hs), [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/next_prime_number.rb), [С](https://github.com/bolcselo/Projects/blob/master/Numbers/next_prime.c), [JavaScript](https://github.com/quitrk/LearningJS/blob/master/Numbers/03.%20Next%20Prime%20Number.js), [Java](https://github.com/MikroMan/Contributions/blob/master/NextPrime.java), [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/nextprime.go)[Python №2](https://github.com/Silverneo/pylearn/blob/master/prime.py)

**Калькулятор для ипотеки** - Вычислить месячные выплаты фиксированного срока в течение заданных N сроков с заданной процентной ставкой. Реализации: [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/mortgage_calculator.rb), [Python] (https://github.com/sysadmin75/Projects/blob/master/Numbers/mortgage/mortgage.py), [C++] (https://github.com/jbruno2/Simple-Programs-and-Solutions/blob/master/C%2B%2B/mortgagecalculator.cpp), [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/mortgage.go)

**Обмен-возврат** - пользователь вводит стоимость и количество денег. Программа рассчитывает сдачу и количество мелких монет, необходимых для сдачи. [[Drhealsgood (Python)]](https://github.com/Drhealsgood/miniprojects/blob/master/number_projects/money_changing/money_changing.py) [[petehuang (Ruby)]](https://github.com/petehuang/Projects/blob/master/Numbers/change_return.rb)[[MikroMan (Java)]](https://github.com/MikroMan/Contributions/blob/master/Change.java) [[ScottKolo (Go)]](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/change.go)

**Перевод из двоичной системы в десятичную и обратно**
Реализации: [Python](https://github.com/Drhealsgood/miniprojects/blob/master/number_projects/conversion/conversions.py), [Ruby](https://github.com/petehuang/Projects/blob/master/Numbers/binary_to_decimal.rb),  [C](https://github.com/hx1997/Projects/blob/master/Numbers/binary_decimal.c)

**Калькулятор** - Сначала простой с базовыми операциями, потом можно добавить фичи. Реализации: [Python](https://github.com/MrBlaise/learnpython/blob/master/Numbers/calc.py), [Haskell](https://github.com/tel/Projects/blob/master/Numbers/Calc.hs), [C](https://github.com/ripperhf/Calculator/blob/master/calc.c), [Java](https://github.com/abarnes7/Java-Calculator/blob/master/basicCalculator.java), [C №2](https://github.com/hx1997/Projects/blob/master/Numbers/calc.c)

**Конвертер температуры, валюты, масс и т.д.** 
Реализации: [Python](https://github.com/Drhealsgood/miniprojects/blob/master/number_projects/conversion/conversions.py), [C++](https://github.com/jbruno2/UnitConversionTools)

**Будильник** - Простые часы, которые играют звук после некоторого числа минут или часов или в определенное время.
[Python](https://github.com/smthc/mini_projects/blob/master/alarm.py), [Java](https://github.com/averageprogrammer/Rooster)

**Расстояние между городами** - Вычисляет расстояние между двумя городами и позволяет пользователю выбрать размерность расстояния. Эта программа может потребовать информацию о городах, такую как долготу и широту. Реализации: [Haskell](https://github.com/tel/Projects/blob/master/Numbers/CityDistance.hs), [Ruby]](https://github.com/petehuang/Projects/blob/master/Numbers/two_city_distance.rb) [[dabillox (Python)]](https://github.com/dabillox/pyprojects/blob/master/citydistance.py)

**Валидатор кредитной карты** - Берет номер кредитной карты от производителя (Visa, MasterCard, American Express, Discover) и проверяет на правильность номер (разберитесь, как кредитные карты используют контрольную сумму). Реализации: [Haskell](https://github.com/tel/Projects/blob/master/Numbers/CCValidator.hs), [Python](https://github.com/stupidgrass/Projects/blob/master/Numbers/credit_card_validator_xwz.py), [Java](https://github.com/MikroMan/Contributions/blob/master/Checksum.java),  [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/creditcard.go)

**Факториал числа** - Решить с помощью циклов и отдельно с помощью рекурсии. n! = n * (n-1) * ... * 1, 0! = 1. Реализации: [Haskell](https://github.com/tel/Projects/blob/master/Numbers/Factorial.hs), [Python](https://github.com/marinamiranda/projects/blob/master/factorial.py), [Python №2](https://github.com/rramchand/Projects-Solutions/blob/master/factorial.py), [Go](https://github.com/ScottKolo/GoProjects/blob/master/Numbers/factorial.go)

**Алгебра комплексных чисел** - Показать сумму, умножение, сопряжение, отрицание в отдельных функциях (разность и деление могут быть сделаны путем использования нескольких уже написанных функций). Реализация: [Haskell](https://github.com/tel/Projects/blob/master/Numbers/ComplexNumberAlgebra.hs)

**Счастливые числа** - Счастливое число определено следующим процессом. Начиная с некоторого положительного целого числа, A happy number is defined by the following process. Starting with any positive integer, replace the number by the sum of the squares of its digits, and repeat the process until the number equals 1 (where it will stay), or it loops endlessly in a cycle which does not include 1. Those numbers for which this process ends in 1 are happy numbers, while those that do not end in 1 are unhappy numbers. Display an example of your output here. Find first 8 happy numbers. [[Quoly (Python)]](https://github.com/Quoly/Projects/blob/master/happy_numbers.py) [[tel (Haskell)]](https://github.com/tel/Projects/blob/master/Numbers/HappyNumbers.hs) [[manoj1992(Java)]](https://github.com/manoj1992/Projects/blob/master/Numbers/HappyNumber.java) [[checkcheckzz (C++)]](https://github.com/checkcheckzz/coding-problem/blob/master/problem/Happy%20Number.cpp)
